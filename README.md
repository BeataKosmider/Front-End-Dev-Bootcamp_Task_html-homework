...
3. Stwórz obrazek z dowolnym źródłem (to co przedstawia zdjęcie nie ma znaczenia), który będzie przekierowywał na stronę “https://www.google.pl”.
...
```
cd existing_repo
git remote add origin https://gitlab.portal.futurecollars.com/beata_kosmider/html-homework.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.portal.futurecollars.com/beata_kosmider/html-homework/-/settings/integrations)
